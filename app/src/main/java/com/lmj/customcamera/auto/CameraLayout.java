...
public class CameraLayout extends FrameLayout {
    ...
    private void parseAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            closeViewId = a.getResourceId(R.styleable.CameraLayout_closeView, -1);
        } finally {
            a.recycle();
        }
    }
    ...
    protected void onAttachedToWindow() {
        ...
        closeView = findViewById(closeViewId);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (r < b) {
            ...
            if (closeView!=null){
                left = (int) (0.05*width);
                top = (int) (0.05*height);
                closeView.layout(left,top,left + closeView.getMeasuredWidth(),top + closeView.getMeasuredHeight());
            }
            // layout centerView;
            if (centerView != null) {
